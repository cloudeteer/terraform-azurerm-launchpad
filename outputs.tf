...
output "key_vault_private_endpoint_private_ip_address" {
  value       = var.create_key_vault ? (var.create_private_runner ? azurerm_private_endpoint.key_vault[0].private_service_connection[*].private_ip_address : null) : null
...
output "network_security_group_id" {
  value       = (var.subnet_id == null ? (var.create_private_runner ? azurerm_network_security_group.this[0].id : null) : null)
...
output "network_security_group_name" {
  value       = (var.subnet_id == null ? (var.create_private_runner ? azurerm_network_security_group.this[0].name : null) : null)
...
output "subnet_name" {
  value       = var.subnet_id == null ? (var.create_private_runner ? azurerm_subnet.this[0].name : null) : split("/", var.subnet_id)[10]
...
output "virtual_network_id" {
  value = (var.subnet_id == null ? (var.create_private_runner ? azurerm_virtual_network.this[0].id : null) :
...
output "virtual_network_name" {
  value       = var.subnet_id == null ? (var.create_private_runner ? azurerm_virtual_network.this[0].name : null) : split("/", var.subnet_id)[8]
